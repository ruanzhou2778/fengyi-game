...
ENDINGS = {
    ...
    "还政归养": {
        ...
        "category": ENDING_CATEGORY_TRIUMPH,
        "headline": "撤帘还政，功成身退",
        "default_reason": "新帝既冠，你交还权柄，退居慈宁",
        "narration": (
            "撤帘那日风很静。你把批了十年红的朱笔交回他手里，"
            "看着他坐上那把你替他守了十年的椅子。"
            "从此慈宁宫的日子长得很——花开花落，奏本再也不送到你面前。"
            "史书大概只会给你一行字，但那十年，是你替这江山撑住的。"
        ),
        "epitaph": "垂帘十载，还政一日，进退皆在她一人。",
    },
    "临朝称制": {
        "icon": "👑",
        "category": ENDING_CATEGORY_TRIUMPH,
        "headline": "去帘临朝，改元称制",
        "default_reason": "摄政权威与朝堂尽在掌握，受群臣之请去帘称制",
        "narration": (
            "那道珠帘被撤了下来——不是还政，是不必再隔着帘子。"
            "你着帝服受百官朝贺，改元称制，诏书上第一次用了自己的年号。"
            "殿外有人跪着颂圣，有人跪着咬牙。你都听得见，"
            "但那已经不重要了：这一次，你坐的是正中间。"
        ),
        "epitaph": "从秀女到称制，她走完了一整条别人不敢想的路。",
    },
    "女帝功成": {
        "icon": "👑",
        "category": ENDING_CATEGORY_TRIUMPH,
        "headline": "生前传位，史留一卷",
        "default_reason": "称制有年，功成传位",
        "narration": (
            "你在生前把玉玺交了出去——这是历代女主都没做到的事。"
            "新君奉你为太上，年号仍用你的那个。"
            "史官落笔时手是稳的：以妇人而有天下，亦异数也。"
            "从秀女到女帝，再从女帝到太上，这条路只有你一个人走完过。"
        ),
        "epitaph": "她生前交出了权柄，所以史书没能把她写成祸水。",
    },
    "神器倾覆": {
        "icon": "🔥",
        "category": ENDING_CATEGORY_DEATH,
        "headline": "复辟兵起，神器旁落",
        "default_reason": "称制后朝局崩坏，宗室与外朝合力复辟",
        "narration": (
            "玄武门的火光照到了含元殿的檐角。"
            "他们冲进来的时候你还坐在御座上，没有起身，也没有躲。"
            "史书会说这是「反正」，会把你那几年的年号一笔划掉——"
            "但那几年真真切切存在过，你比谁都清楚。"
        ),
        "epitaph": "她坐过那把椅子，这件事，划不掉。",
    },
    "幽居慈宁": {
        "icon": "⛓️",
        "category": ENDING_CATEGORY_FALL,
        "headline": "权柄尽失，奉养慈宁",
        "default_reason": "摄政权威扫地，被尊养于慈宁宫",
        "narration": (
            "他们说这是「奉养」。慈宁宫的份例一样不少，太医日日请脉，"
            "只是宫门从外面上了锁，通政司的奏本再也送不进来。"
            "你隔着窗看见那个自己抱过的孩子远远走过，他没有回头。"
            "权柄这东西，握久了会以为是自己的。"
        ),
        "epitaph": "垂帘之手终被推开，尊荣与幽禁只隔一道宫门。",
    },
    "冷宫幽闭": {
        "icon": "🏚️",
        "category": ENDING_CATEGORY_FALL,
